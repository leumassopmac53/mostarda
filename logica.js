...
player = {
        ...
        update() {
    document.querySelector("#fome").setAttribute("width", this.fome);
    document.querySelector("#humor").setAttribute("width", this.humor);
    document.querySelector("#sono").setAttribute("width", this.sono);
},
...
const comida = {
  ...
  if(ge.funcao.aaBb(comida.id, entidade)){
    ...
    elemento.style.left = comida.x
    elemento.style.top = comida.y
  }
}
}
...
document.addEventListener("visibilitychange", () => {
  ...
  if (document.visibilityState === "hidden") {
    ...
    console.log("Mostarda ficou invisível");
    ...
    console.log("Mostarda voltou a ficar visível");
